...
class WorkerThread(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                request = self._requests_queue.get(True, self._poll_timeout)[1]
            except Queue.Empty:
                continue
            else:
                if self._dismissed.isSet():
...
class PriorityThreadPool:
    ...
    def putRequest(self, request, block=True, timeout=None):
        ...
        print("I am putting requests!!=====================start")
        assert isinstance(request, WorkRequest)
        # don't reuse old work requests
        assert not getattr(request, 'exception', None)
        print("I am putting requests!!=====================middle")
        self._requests_queue.put((1,request), block, timeout)
        print("I am putting requests!!=====================end")
    ...
    def poll(self, block=False):
        ...
        while True:
            ...
            try:
                ...
                request, result = self._results_queue.get(block=block)[1]
